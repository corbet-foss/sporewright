...
This maps Sporewright against the
...
Legend: ✅ met · 🔶 pending (gated) · ❌ not met · ➖ not applicable
...
| Criterion | Status | Evidence |
|---|---|---|
| Public, version-controlled (distributed) source | 🔶 | Git repository is private pending the separate publication-readiness and visibility decision |
| Unique, semantic version numbers + tags | ✅ | `0.3.0`, SemVer; tags on release |
